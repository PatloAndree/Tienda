        ...
        <div class="ltn__header-middle-area">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="site-logo">
                            <a href="index.html"><img src="{{asset('asset/img/logo.png')}}" alt="Logo"></a>
                        </div>
                    </div>
                        ...
                        <div class="header-contact-search">
                            ...
                            <div class="header-search-2">
                                <form id="#123" method="get"  action="#">
                                    <input type="text" name="search" value="" placeholder="Busca un producto aquí..."/>
                                    <button type="submit">
                                ...
                                <li>
                                    ...
                                    <div class="mini-cart-icon mini-cart-icon-2">
                                        <a href="#ltn__utilize-cart-menu" class="ltn__utilize-toggle">
                                            ...
                                            <h6><span>Tus favoritos</span> <span class="ltn__secondary-color"></span></h6>
                                        </a>
                                    </div>
                                </li>
                                <li>      
                        ...
                        <div class="header-menu header-menu-2">
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        <li class="menu-icon"><a href="#">Incio</a>
                                            {{-- <ul>
                                        ...
                                        {{-- <li class="menu-icon"><a href="#">Pages</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li><a href="#">Shop Pages</a>
                                                    <ul>
                                                        <li><a href="{{route('shop.index')}}">Shop Lar</a></li>
                                        ...
                                        <li class="menu-icon"><a href="#">Acerca de</a>
                                            <ul>
                                                <li><a href="portfolio.html">Portfolio</a></li>
                                                <li><a href="portfolio-2.html">Portfolio - 02</a></li>
                                                <li><a href="portfolio-details.html">Portfolio Details</a></li>
                                        ...
                                        <li class="menu-icon"><a href="#">Noticias</a>
                                            <ul>
                                                <li><a href="blog.html">News</a></li>
                                                <li><a href="blog-grid.html">News Grid</a></li>
                                                <li><a href="blog-left-sidebar.html">News Left sidebar</a></li>
