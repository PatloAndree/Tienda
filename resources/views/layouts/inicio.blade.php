...
<div class="body-wrapper">
    ...
    <div class="ltn__slider-area ltn__slider-3 ltn__slider-6 section-bg-1">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white---">
            ...
            <!-- ltn__slide-item  -->
            <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---" data-bs-bg="{{asset('asset/img/slider/slider2.png')}}">
                <div class="ltn__slide-item-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{asset('asset/img/product/celulares/fotos3.jpg')}}" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{asset('asset/img/product/celulares/fotos1.jpg')}}" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{asset('asset/img/product/celulares/foto2.jpg')}}" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{asset('asset/img/product/celulares/xiomi2.webp')}}" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="badge-1">Hot</li>
                                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="{{route('shop.index')}}"><img src="{{asset('asset/img/banner/publi.webp')}}" alt="Banner Image"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row  ltn__blog-slider-one-active slick-arrow-1">
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        <div class="ltn__blog-img">
                            <a href="blog-details.html"><img src="{{asset('asset/img/blog/iphone.webp')}}" alt="#"></a>
                        </div>
                            ...
                            <div class="ltn__blog-meta">
                                <ul>
                                    ...
                                    <li class="ltn__blog-comment">
                                        <a href="#"><i class="icon-speech"></i> 1</a>
                                    </li>
                                </ul>
                            </div>
                            <h3 class="ltn__blog-title blog-title-line"><a href="blog-details.html">Lanzamiento de iphone 15</a></h3>
                        </div>
                    </div>
                </div>
                <!-- Blog Item -->
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        ...
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title blog-title-line"><a href="blog-details.html">Errores en lanzamiento </a></h3>
                        </div>
                    </div>
                </div>
                <!-- Blog Item -->
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        <div class="ltn__blog-img">
                            <a href="blog-details.html"><img src="{{asset('asset/img/blog/samsung.jpg')}}" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                            ...
                            <h3 class="ltn__blog-title blog-title-line"><a href="blog-details.html">Nuevo Samsung Flip 212</a></h3>
                        </div>
                    </div>
                </div>
                <!-- Blog Item -->
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item">
                        <div class="ltn__blog-img">
                            <a href="blog-details.html"><img src="{{asset('asset/img/blog/5.jpg')}}" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
